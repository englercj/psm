...
FileManager.prototype.tailLog = function(limit, cb) {
    var self = this;
    
    self.read(self.paths.log, function(err, str) {
	var lines = str.split('\n');
...
FileManager.prototype.write = function(file, type, cb) {
    var self = this;
};
...
FileManager.prototype.listFiles = function(dir, cb) {
    var self = this;
};

FileManager.prototype.listDirs = function(dir, cb) {
    var self = this;
};
