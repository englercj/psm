...
var Worker = exports.Worker = function(obj) {
    var self = this;
    events.EventEmitter.call(self);

    self._serverId = obj.serverId;//process.argv[2];
    self._socketFile = obj.socketFile;//process.argv[3];
    self._managerPort = obj.managerPort;//process.argv[4];
