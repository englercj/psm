    ...
    self._outputParsers = [
        ...
        function(str) {
            ...
            if(parts) {
                ...
                //1 = timestamp,
                //2 = startup time
                log(this._settings.name + ' has started up (' + parts[2] + ')', 'info');
        ...
        function(str) {
            ...
            if(parts) {
                ...
                if(scrn || (parts[2] == 'WARNING' && parts[3] == '**** FAILED TO BIND TO PORT!')) {
                    ...
                    log(this._settings.name + ' unable to start: ' + parts[3], 'error');
                    this.stop(true, true);
                } else {
                    log(this._settings.name + ' Error: ' + parts[0], 'error', scrn);
                }
            }
        },
        function(str) {
